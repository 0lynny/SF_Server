...
public interface CsvParser {
	 ...
	 * @param lines CSV 파일의 lines
	 * @return 파싱된 데이터의 리스트
	 * @throws CsvParseException 파싱 중 오류 발생 시
	 */
	List<CsvDataDto> parse(List<String> lines) throws CsvParseException;

	/**
	 * CSV 파일의 헤더를 파싱합니다.
	 * @param line CSV 파일의 line
	 * @return 파싱된 헤더 정보
	 * @throws CsvParseException 파싱 중 오류 발생 시
	 */
	List<String> parseHeader(String line) throws CsvParseException;
}
